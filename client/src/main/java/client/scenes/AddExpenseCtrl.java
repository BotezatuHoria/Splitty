...
public class AddExpenseCtrl {
    ...
    @FXML // fx:id="equalCheck"
    private CheckBox equalCheck; // Value injected by FXMLLoader
    ...
    @FXML // fx:id="someCheck"
    private CheckBox someCheck; // Value injected by FXMLLoader
